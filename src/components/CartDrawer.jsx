  ...
  return (
    <div className={`fixed top-0 right-0 h-full w-96 bg-white shadow-lg transform transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            ...
            <div key={item.id} className="flex items-center mb-4">
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center mt-2">
                  <button onClick={() => updateQuantity(item.id, item.quantity - 1)} className="bg-gray-200 px-2 rounded-lg">-</button>
      ...
      <div className="absolute bottom-0 left-0 w-full p-4 border-t bg-white">
        ...
        <button onClick={handleCheckout} className="w-full bg-blue-500 text-white py-3 rounded-lg mt-4">Тооцоо хийх</button>
      </div>
    </div>
  );
};
